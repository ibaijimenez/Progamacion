...
public class Main {
    ...
    public static Map<String, List<Coche>> cochesMatricula ;
    public static void main(String[] args) {
        ...
        String listaCochesNuevos = coches.stream()
                .filter(c -> c.getAno()>2015).toList().toString();
        System.out.println("Coches a partir de 2015: " + listaCochesNuevos);
        String listCochesViejos = coches.stream()
                .filter(c -> c.getAno()<2015).toList().toString();
        System.out.println("Coches mas viejos de 2015: " + listCochesViejos );
    }
}