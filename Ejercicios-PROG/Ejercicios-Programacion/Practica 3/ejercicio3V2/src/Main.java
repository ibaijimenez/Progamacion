...
public class Main {
    ...
    public static Deque <String> nombresLibros;
    ...
    public static void mostrarLibros() {
        try {
            Deque <String> librosOrdenados = new ArrayDeque<>();
            while (!nombresLibros.isEmpty()) {
